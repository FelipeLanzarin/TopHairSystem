...
//			cityRown.setCity(city);
	...
	/**
	 * Retorna todos os produtos na lista no formato ProductRown para ser utilizado na tabela
	 * @return
	 */
	public static List<ProductRown> getProductManagers(){
		List<ProductRown> list = new ArrayList<>();
		for (Product obj : ProductManager.getProducts()) {
			ProductRown objRown = new ProductRown();
			objRown.setId(obj.getId());
			objRown.setName(obj.getName());
